...
import com.example.pekedexexamenmvvm.R
import com.example.pekedexexamenmvvm.adapter.ListStatAdapter
import com.example.pekedexexamenmvvm.databinding.ActivityDetailBinding
import com.example.pekedexexamenmvvm.responseApi.DetailModel
import com.example.pekedexexamenmvvm.responseApi.FlavorTextEntries
import com.example.pekedexexamenmvvm.responseApi.Stats
import com.example.pekedexexamenmvvm.responseApi.TypeResponse
import com.example.pekedexexamenmvvm.viewmodel.DetailActivityViewModel
import com.example.tipedex.adapter.ListTipeAdapter

// Pinta los detalles de los pokemon
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rvType.adapter = listTipeAdapter // Se pinta la respuesta del (tipo de pokemon)
        val layoutManger = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false) // guarda la forma
        binding.rvType.layoutManager = layoutManger // asigna el estilo

        binding.rvDetail.adapter = listStatAdapter // Se pinta la respuesta del detalle del pokemon
        val layoutManager = LinearLayoutManager(this) // Guarda y lo reasigna
        binding.rvDetail.layoutManager = layoutManager // asigna el estilo
    ...
    private fun setPokemonType(typePokemon: List<TypeResponse>) {
        ...
        for (name in typePokemon) {
         ...
         // Pinta el fondo dependiendo del tipo del pokemon
        when {
    ...
    // Pinta el estado del pokemon ataque, puntos de ataque, etc
